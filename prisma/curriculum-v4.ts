...
export interface SpecTask {
  ...
  practiceReq: string;
  priority: Tier;
  track: "AI_ENGINEERING" | "SOFTWARE_ENGINEERING" | "GATE_PREP";
...
export const ROADMAP_DSA: SpecTask[] = [
  { week: 1, title: "DSA Introduction & Big O Notation", category: "DSA", subtopics: ["What is DSA?", "Time & Space Complexity", "Big O, Omega, Theta"], minutes: 60, practiceReq: "Analyze 5 snippets (Striver reference); Core 100 warm-up ×3", priority: "CORE", track: "SOFTWARE_ENGINEERING", difficulty: "Easy", prerequisites: [], block: "Block 1", dayOffset: 0 },
  { week: 1, title: "Arrays Fundamentals & Operations", category: "DSA", subtopics: ["Traversal, insertion, deletion", "Two Pointers baseline", "Prefix sums"], minutes: 45, practiceReq: "Core 100 arrays ×6", priority: "CORE", track: "SOFTWARE_ENGINEERING", difficulty: "Easy", prerequisites: ["DSA Introduction & Big O Notation"], block: "Block 2", dayOffset: 0 },
  { week: 1, title: "Strings & Searching Algorithms", category: "DSA", subtopics: ["String manipulation", "Binary Search patterns", "Rotated array search"], minutes: 45, practiceReq: "Core 100 strings/binary-search ×6", priority: "CORE", track: "SOFTWARE_ENGINEERING", difficulty: "Easy", prerequisites: ["Arrays Fundamentals & Operations"], block: "Block 1", dayOffset: 1 },
  { week: 1, title: "Basic Sorting Algorithms", category: "DSA", subtopics: ["Merge/Quick Sort", "Sorting complexity narration"], minutes: 45, practiceReq: "Implement Merge + Quick from memory", priority: "CORE", track: "SOFTWARE_ENGINEERING", difficulty: "Easy", prerequisites: ["DSA Introduction & Big O Notation"], block: "Block 2", dayOffset: 2 },
  { week: 2, title: "Recursion & Backtracking Foundations", category: "DSA", subtopics: ["Call stack & base cases", "Subsets/permutations", "N-Queens intuition"], minutes: 60, practiceReq: "Core 100 recursion/backtracking ×5", priority: "CORE", track: "SOFTWARE_ENGINEERING", difficulty: "Medium", prerequisites: ["DSA Introduction & Big O Notation"], block: "Block 1", dayOffset: 7 },
  { week: 2, title: "Linked Lists & Fast/Slow Pointer", category: "DSA", subtopics: ["Singly/doubly LL", "Cycle detection", "Reverse LL"], minutes: 45, practiceReq: "Core 100 linked-list ×5", priority: "CORE", track: "SOFTWARE_ENGINEERING", difficulty: "Medium", prerequisites: ["Arrays Fundamentals & Operations"], block: "Block 2", dayOffset: 8 },
  { week: 2, title: "Stack, Queue & Deque", category: "DSA", subtopics: ["Monotonic stack awareness", "Next Greater Element", "Queue/Deque patterns"], minutes: 45, practiceReq: "Core 100 stack/queue ×5", priority: "CORE", track: "SOFTWARE_ENGINEERING", difficulty: "Medium", prerequisites: ["Arrays Fundamentals & Operations"], block: "Block 3", dayOffset: 9 },
  { week: 3, title: "Hashing, HashMap & Sliding Window", category: "DSA", subtopics: ["Frequency counting", "Fixed/variable sliding window"], minutes: 45, practiceReq: "Core 100 hashing/sliding-window ×6", priority: "CORE", track: "SOFTWARE_ENGINEERING", difficulty: "Medium", prerequisites: ["Arrays Fundamentals & Operations"], block: "Block 1", dayOffset: 14 },
  { week: 3, title: "Binary Trees & BST", category: "DSA", subtopics: ["DFS/BFS traversals", "BST validation", "LCA"], minutes: 45, practiceReq: "Core 100 trees/BST ×6", priority: "CORE", track: "SOFTWARE_ENGINEERING", difficulty: "Medium", prerequisites: ["Recursion & Backtracking Foundations"], block: "Block 2", dayOffset: 16 },
  { week: 3, title: "Heaps & Priority Queues", category: "DSA", subtopics: ["Heapify", "Top-K patterns"], minutes: 45, practiceReq: "Core 100 heaps ×4", priority: "CORE", track: "SOFTWARE_ENGINEERING", difficulty: "Medium", prerequisites: ["Binary Trees & BST"], block: "Block 3", dayOffset: 18 },
  { week: 4, title: "Graph Algorithms (BFS/DFS/Dijkstra)", category: "DSA", subtopics: ["BFS/DFS", "Topological sort", "Union-Find", "Dijkstra/shortest paths", "MST awareness (Kruskal/Prim)"], minutes: 60, practiceReq: "Core 100 graphs ×8", priority: "CORE", track: "SOFTWARE_ENGINEERING", difficulty: "Hard", prerequisites: ["Binary Trees & BST", "Stack, Queue & Deque"], block: "Block 1", dayOffset: 21 },
  { week: 4, title: "Dynamic Programming Foundations", category: "DSA", subtopics: ["Memoization vs tabulation", "1D DP (Climb/Rob/Kadane)", "2D DP (LCS, paths)", "Bit manipulation"], minutes: 60, practiceReq: "Core 100 DP ×8 + bit manipulation ×2", priority: "CORE", track: "SOFTWARE_ENGINEERING", difficulty: "Hard", prerequisites: ["Recursion & Backtracking Foundations"], block: "Block 2", dayOffset: 24 },
  { week: 4, title: "Greedy Algorithms & Classic Patterns", category: "DSA", subtopics: ["Greedy choice", "Intervals", "Trie"], minutes: 45, practiceReq: "Core 100 greedy/intervals/trie ×6", priority: "CORE", track: "SOFTWARE_ENGINEERING", difficulty: "Medium", prerequisites: ["Basic Sorting Algorithms"], block: "Block 3", dayOffset: 26 },
  { week: 4, title: "DSA Interview Patterns & Mock Interview", category: "DSA", subtopics: ["Pattern recall drill", "Timed mock", "Explain-out-loud"], minutes: 90, practiceReq: "Re-solve 10 flagged Core-100; 1 timed mock", priority: "CORE", track: "SOFTWARE_ENGINEERING", difficulty: "Hard", prerequisites: ["Dynamic Programming Foundations", "Graph Algorithms (BFS/DFS/Dijkstra)"], block: "Block 4", dayOffset: 27 },
];
...
export const ROADMAP_CONSOLIDATION: SpecTask[] = [
  ...
  { week: 13, title: "DSA Pattern Consolidation", category: "DSA", subtopics: ["Sliding window review", "DP patterns", "Graph templates"], minutes: 120, practiceReq: "Re-solve 10 flagged Core-100", priority: "IMPORTANT", track: "SOFTWARE_ENGINEERING", difficulty: "Medium", prerequisites: [], block: "Block 2", dayOffset: 87 },
